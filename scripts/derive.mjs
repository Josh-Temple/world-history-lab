...
const TAG_ALIASES = new Map([
  ...
  ["state_order", "state-formation"],
  ["centralization", "state-formation"],
  ["political_reform", "politics"],
  ["military_reform", "war"],
  ["foreign_relations", "politics"],
  ["opening_of_japan", "politics"],
  ["treaty", "politics"],
  ["coup", "politics"],
  ["monarchy", "politics"],
  ["rights", "politics"],
  ["symbolic-politics", "politics"],
  ["regulation", "politics"],
  ["ideology", "politics"],
  ["organization", "politics"],
  ["periodization", "politics"],
  ["great_powers", "politics"],
  ["gunboat_diplomacy", "politics"],
  ["cold_war", "politics"],
  ["economics", "economy"],
  ["economic", "economy"],
  ["trade", "economy"],
  ...
  ["imperialism", "empire"],
  ["british_empire", "empire"],
  ["colonialism", "colonization"],
  ["annexation", "colonization"],
  ["decolonization", "colonization"],
  ["colonial_partition", "colonization"],
  ["colonial_rule", "colonization"],
  ["chartered_company", "colonization"],
  ["scramble_for_africa", "colonization"],
  ["slavery", "colonization"],
  ["partition", "colonization"],
  ["exploration_routes", "exploration"],
  ["silk-road", "exploration"],
]);

// These tags carry useful region, actor, or period context in source records,
// but the derived tag-cluster taxonomy is intentionally broad. Accept them
// without warning and let event category or semantic aliases determine the
// normalized cluster tag.
...
function validateEventTags(events) {
  ...
  for (const event of events) {
    ...
    for (const tag of tags) {
      ...
      } else if (CONTEXT_ONLY_TAGS.has(trimmed)) {
        continue;
      } else {
